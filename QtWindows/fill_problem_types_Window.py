...
class Ui_inputParamProcedureWindow(object):
    def setupUi(self, inputParamProcedureWindow):
        ...
        self.inputButton.clicked.connect(lambda: fill_problem_types(self.levelLineEdit.text(), self.levelLineEdit_2.text()))
    ...
    def retranslateUi(self, inputParamProcedureWindow):
        ...
        self.startLabel.setText(_translate("inputParamProcedureWindow", "Новый тип проблемы"))
        self.passLabel.setText(_translate("inputParamProcedureWindow", "Введите название проблемы"))
        ...
        self.passLabel_2.setText(_translate("inputParamProcedureWindow", "Введите приоритет проблемы"))
        self.levelLineEdit_2.setPlaceholderText(_translate("inputParamProcedureWindow", "Пример: Высочайший"))
...
def fill_problem_types(desc, priority):
    from WorkWithDB import fill_problem_types
    fill_problem_types(desc, priority)
    msgBox = QMessageBox()
    msgBox.setText("Проблема добавлена")
    msgBox.exec_()
    pass

def show_fill_problem_types_Window():
    global show_fill_appeal_statuses_Window
    show_fill_appeal_statuses_Window = QtWidgets.QDialog()
    ui = Ui_inputParamProcedureWindow()
    ui.setupUi(show_fill_appeal_statuses_Window)
    show_fill_appeal_statuses_Window.show()


def closeInputParamProcedureWindow():
    show_fill_problem_types_Window.close()