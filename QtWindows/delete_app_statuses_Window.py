...
class Ui_inputParamProcedureWindow(object):
    def setupUi(self, inputParamProcedureWindow):
        ...
        self.inputButton.clicked.connect(lambda: delete_app_statuses(self.levelLineEdit.text()))

        self.retranslateUi(show_delete_app_statuses_Window)
        QtCore.QMetaObject.connectSlotsByName(show_delete_app_statuses_Window)
    ...
    def retranslateUi(self, inputParamProcedureWindow):
        ...
        self.startLabel.setText(_translate("inputParamProcedureWindow", "Удаление статуса приложения"))
        self.passLabel.setText(_translate("inputParamProcedureWindow", "Введите статус приложения:"))
        self.levelLineEdit.setPlaceholderText(_translate("inputParamProcedureWindow", "Пример: В процессе работы"))
...
def delete_app_statuses(level):
    from WorkWithDB import delete_app_statuses
    delete_app_statuses(level)
    msgBox = QMessageBox()
    msgBox.setText("Статус удален")
    msgBox.exec_()
    pass

def show_delete_app_statuses_Window():
    global show_delete_app_statuses_Window
    show_delete_app_statuses_Window = QtWidgets.QDialog()
    ui = Ui_inputParamProcedureWindow()
    ui.setupUi(show_delete_app_statuses_Window)
    show_delete_app_statuses_Window.show()


def closeInputParamProcedureWindow():
    show_delete_app_statuses_Window.close()