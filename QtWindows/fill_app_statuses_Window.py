...
class Ui_inputParamProcedureWindow(object):
    def setupUi(self, inputParamProcedureWindow):
        ...
        self.inputButton.clicked.connect(lambda: fill_app_statuses(self.levelLineEdit.text()))
    ...
    def retranslateUi(self, inputParamProcedureWindow):
        ...
        self.startLabel.setText(_translate("inputParamProcedureWindow", "Новый статус приложения"))
...
def fill_app_statuses(level):
    from WorkWithDB import fill_app_statuses
    fill_app_statuses(level)
    msgBox = QMessageBox()
    msgBox.setText("Статус добавлен")
    msgBox.exec_()
    pass

def show_fill_app_statuses_Window():
    global show_fill_app_statuses_Window
    show_fill_app_statuses_Window = QtWidgets.QDialog()
    ui = Ui_inputParamProcedureWindow()
    ui.setupUi(show_fill_app_statuses_Window)
    show_fill_app_statuses_Window.show()


def closeInputParamProcedureWindow():
    show_fill_app_statuses_Window.close()
