...
class Ui_inputParamProcedureWindow(object):
    def setupUi(self, inputParamProcedureWindow):
        ...
        self.inputButton.clicked.connect(lambda: fill_appeal_statuses(self.levelLineEdit.text()))

        self.retranslateUi(show_fill_appeal_statuses_Window)
        QtCore.QMetaObject.connectSlotsByName(show_fill_appeal_statuses_Window)
    ...
    def retranslateUi(self, inputParamProcedureWindow):
        ...
        self.startLabel.setText(_translate("inputParamProcedureWindow", "Добавление статуса заявки"))
        self.passLabel.setText(_translate("inputParamProcedureWindow", "Добавьте статус заявки:"))
...
def fill_appeal_statuses(level):
    from WorkWithDB import fill_appeal_statuses
    fill_appeal_statuses(level)
    msgBox = QMessageBox()
    msgBox.setText("Статус добавлен")
    msgBox.exec_()
    pass

def show_fill_appeal_statuses_Window():
...
def closeInputParamProcedureWindow():
    show_fill_appeal_statuses_Window.close()
